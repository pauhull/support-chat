...
public class SupportChat extends Plugin {
    ...
    public static final String CHAT_QUIT = "§b§lKlicke hier, um den Chat zu beenden";
    public static final String CLICK_HERE = "§b§lKlicke hier, um sie anzunehmen";
    ...
    public static final String REQUEST = PREFIX + "Der Spieler §e%s§r§f hat eine Support-Anfrage gesendet. ";
